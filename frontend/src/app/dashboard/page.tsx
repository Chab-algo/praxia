...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <a href="/dashboard/recipes" className="rounded-lg border p-6 hover:border-primary transition-colors">
          <p className="text-sm text-muted-foreground">Recipes Available</p>
          <p className="text-3xl font-bold">{stats.recipes}</p>
        </a>
        <a href="/dashboard/agents" className="rounded-lg border p-6 hover:border-primary transition-colors">
          <p className="text-sm text-muted-foreground">Agents</p>
          <p className="text-3xl font-bold">{stats.agents}</p>
        </a>
        <a href="/dashboard/executions" className="rounded-lg border p-6 hover:border-primary transition-colors">
          <p className="text-sm text-muted-foreground">Executions</p>
          <p className="text-3xl font-bold">{stats.executions}</p>
        </a>
        <a href="/dashboard/usage" className="rounded-lg border p-6 hover:border-primary transition-colors">
